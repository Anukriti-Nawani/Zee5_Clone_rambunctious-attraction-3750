        ...
        <div className={styles.grand}>
          <div className={styles.parent}>
            <div className={styles.container1}>
              <Text defaultChecked className={styles.watchAdd}>
                Watch Ad-Free with Premium!
              </Text>
              <Box className={styles.box}>
                <Text>
                  <CheckIcon className={styles.two} />
                  2800+ Blockbuster Movies
                </Text>
                <Text>
                  <CheckIcon className={styles.web} />
                  150+ Web Series
                </Text>
                <Text>
                  <CheckIcon className={styles.live} />
                  Live TV Before TV
                </Text>
                <Text>
                  <CheckIcon className={styles.offer} />
                  Offer: Extra 10% OFF on CC
                </Text>
                <Text>
                ...
                <Text>
                  <CheckIcon className={styles.eduara} />
                  Eduaurra Competitive Exams
                </Text>
              </Box>
            </div>
