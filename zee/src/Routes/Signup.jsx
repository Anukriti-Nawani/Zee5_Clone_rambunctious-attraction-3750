import { Box, Button, Input, Text, VStack, Link,useToast } from "@chakra-ui/react";
...
return (
 ...
 <Navbar />
        ...
        <Box mb={7} height="100%">
         <Text fontSize="xl" fontWeight="bold" lineHeight='3em' marginTop="2rem">Create a new account</Text>
         ...
         <Input value={text.email} onChange={(event) => setText({ ...text, email: event.target.value })} type='email' variant='flushed' borderColor='rgb(111, 111, 111)' color="black" focusBorderColor='rgb(176, 80, 255)' placeholder='E-mail or mobile number' w='333px' />
            ...
            <Text fontSize='sm' color='gray'>Already Registered?<Link to="/login" onClick={goTologin} color="purple">Login</Link></Text>
