...
function Footer() {
   return (
      <Box borderTop='1px solid rgb(27, 27, 27)' py={7} px={14} color='lightgray' backgroundColor="black">
         <HStack gap={3}>
            <Text className={styles.footer} fontWeight='bold'>Download Apps</Text>
            ...
            <Spacer />
            <Text className={styles.footer}  fontWeight='bold'>Connect with us</Text>
            <HStack gap={1}>
         ...
         <HStack my={7} gap={4} color='rgb(111, 111, 111)' fontSize='12px'>
            <Box className={styles.footerHover} borderRight='1px solid gray' pr={7}>About us</Box>
            <Box className={styles.footerHover} borderRight='1px solid gray' pr={7}>Help Center</Box>
            <Box className={styles.footerHover}  borderRight='1px solid gray' pr={7}>Privacy Policy</Box>
            <Box className={styles.footerHover} >Terms of Use</Box>
         </HStack>
         <HStack gap={10} mb={14}>
            <VStack fontSize='13px' align='start' color='rgb(111, 111, 111)'>
               <Text className={styles.footer} fontWeight='bold' my={3} color='white'>Popular TV Shows</Text>
               ...
               <Text className={styles.footerHover}>Kyun Rishton Mein Katti Bat</Text>
            </VStack>
            <VStack fontSize='13px' align='start' color='rgb(111, 111, 111)'>
               <Text className={styles.footer} fontWeight='bold' my={3} color='white'>Premium Movies</Text>
               <Text className={styles.footerHover}>Kya Meri Sonam Gupta Bewafa Hai?</Text>
            ...
            <VStack fontSize='13px' align='start' color='rgb(111, 111, 111)'>
               <Text className={styles.footer} fontWeight='bold' my={3} color='white'>Popular LIVE TV Channels</Text>
            ...
            <VStack fontSize='13px' align='start' color='rgb(111, 111, 111)'>
               <Text className={styles.footer} fontWeight='bold' my={3} color='white'>Popular Web Series</Text>
            ...
            <VStack fontSize='13px' align='start' color='rgb(111, 111, 111)'>
               <Text className={styles.footer} fontWeight='bold' my={3} color='white'>Bollywood Top Celebrities</Text>
